	...
	<div class="page-container">
		...
		<div class="random-box">
			<div v-for="i,index in randomArr" :key="index">
				<div class="single-btn" :key="index" v-if="i < GLOBAL.shiyixuanwuResult.length">
		...
		<div class="result-box">
			<div class="single-result" v-for="i in result">{{i.join(',')}}</div>
			<div style="clear: both;"></div>
		</div>
...
export default {
	...
	data() {
		return {
			allResult: this.GLOBAL.shiyixuanwuResult,
			result: this.GLOBAL.shiyixuanwuResult,
			count: 10,
	...
	created() {
		this.count = this.GLOBAL.shiyixuanwuResult.length
		this.copyRandom()
	},
